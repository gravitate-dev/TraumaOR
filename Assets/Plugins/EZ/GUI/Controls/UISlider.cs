...
public class UISlider : AutoSpriteControlBase
{
	...
	/// <summary>
	/// The distance the knob should "float" in front
	/// of the bar.
	/// </summary>
	public float knobFloatDistance = 0.1f;
	...
	public override void Copy(SpriteRoot s, ControlCopyFlags flags)
	{
		...
		if ((flags & ControlCopyFlags.Settings) == ControlCopyFlags.Settings)
		{
			...
			knobFloatDistance = b.knobFloatDistance;
			knobSize = b.knobSize;
	...
	{
		Vector3 pos = new Vector3(0,0,-knobFloatDistance);
